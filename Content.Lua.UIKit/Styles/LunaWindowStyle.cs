...
using Content.Lua.UIKit.Resources;
...
public static class LunaWindowStyle
{
    ...
    public static void ApplyCompactStyle(Control root)
    {
        foreach (var child in root.Children)
        {
            ...
            {
                case Label label:
                    label.AddStyleClass("LabelSmall");
                    label.FontOverride = FontSmall;
                    break;
                case RichTextLabel rich:
                    rich.AddStyleClass("LabelSubText");
                    break;
                case Button button:
                    button.AddStyleClass("ButtonNavCompact");
                    if (button.Label != null)
                        button.Label.FontOverride = FontSmall;
                    break;
                case Slider slider:
                    slider.AddStyleClass("SliderThin");
                    break;
            }
    ...
    public static void StyleCompactRich(RichTextLabel rich)
    {
        rich.AddStyleClass("LabelSmall");
        rich.AddStyleClass("LabelSubText");
    }

    public static string CompactMarkup(string markup)
    {
        return $"[font size={FontSizeTiny}]{markup}[/font]";
    }
