...
/// Own <see cref="Activated"/> flag — do not share ItemToggle with ToggleClothing (phase cloak).
/// </summary>
...
public sealed partial class PersonalShieldComponent : Component
{
    ...
    /// <summary>
    /// Whether the wearer has requested the shield on. Independent from clothing ItemToggle
    /// (phase cloak / magboots / etc. own that).
    /// </summary>
    [DataField, AutoNetworkedField]
    ...
    [DataField]
    public SoundSpecifier SoundDeactivate = new SoundPathSpecifier("/Audio/Weapons/ebladeoff.ogg");

    [DataField]
    public SoundSpecifier SoundFail = new SoundPathSpecifier("/Audio/Machines/button.ogg")
    {
