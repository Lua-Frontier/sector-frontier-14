...
public sealed partial class SharedPersonalShieldSystem : EntitySystem
{
    ...
    private void OnAction(Entity<PersonalShieldComponent> ent, ref PersonalShieldActionEvent ev)
    {
        ...
        // Turning on while fractured / offline
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var shield))
        {
            ...
            if (shield.Runtime.Shatter > 0f)
            {
                ...
                DirtyIfChanged(ent, before, wasActivated);
                continue;
            }
            ...
            // Battery empty while requested on — drop request so cloak ItemToggle stays untouched
    ...
    private void DirtyIfChanged(Entity<PersonalShieldComponent> ent, PersonalShieldRuntime before, bool wasActivated)
    {
