...
/// <summary>
/// Minimal Shitmed relay event for systems that need body-part-specific DoAfter timing.
/// </summary>
public sealed class GetDoAfterDelayMultiplierEvent : EntityEventArgs, IBodyPartRelayEvent
{
    public BodyPartType TargetBodyPart { get; init; } = BodyPartType.Other;
