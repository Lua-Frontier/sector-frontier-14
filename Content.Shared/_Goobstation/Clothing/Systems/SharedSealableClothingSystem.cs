...
public abstract partial class SharedSealableClothingSystem : EntitySystem
{
    ...
    private void NextSealProcess(Entity<SealableClothingControlComponent> control)
    {
        ...
        var doAfterArgs = new DoAfterArgs(EntityManager, uid, sealableComponent.SealingTime, new SealClothingDoAfterEvent(), uid, target: processingPart) // Frontier: local DoAfterArgs has no showTo parameter
        {
            NeedHand = false,
