...
public sealed partial class SealableClothingControlComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier FailSound = new SoundPathSpecifier("/Audio/Mecha/mechmove03.ogg");

    [DataField]
    public SoundSpecifier SealCompleteSound = new SoundPathSpecifier("/Audio/Mecha/mechmove03.ogg");

    [DataField]
    public SoundSpecifier UnsealCompleteSound = new SoundPathSpecifier("/Audio/Mecha/mechmove03.ogg");
    #endregion
}
