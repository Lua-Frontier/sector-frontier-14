...
public sealed partial class ShuttleSystem
{
    ...
    private readonly SoundSpecifier _startupSound = new SoundPathSpecifier("/Audio/_Lua/Effects/Shuttle/hyperspace_begin.ogg")
    {
        Params = AudioParams.Default.WithVolume(-5f),
    };

    private readonly SoundSpecifier _arrivalSound = new SoundPathSpecifier("/Audio/_Lua/Effects/Shuttle/hyperspace_end.ogg")
    {
        Params = AudioParams.Default.WithVolume(-5f),
    };
