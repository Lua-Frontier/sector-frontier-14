...
using Content.Lua.Shared.Administration.ChunkMonitor;
...
public sealed class ChunkMonitorEui : BaseEui
{
    ...
    private IShuttleGridAccessSystem _gridAccess = default!;
    ...
    public ChunkMonitorEui()
    {
        ...
        _mapMan = _entMan.System<SharedMapSystem>();
        ...
        _gridAccess = _entMan.System<IShuttleGridAccessSystem>();
