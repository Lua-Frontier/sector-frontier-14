...
public sealed class CompanyInviteSystem : EntitySystem
{
    ...
    private sealed record PendingInvite(int _, ICommonSession Inviter, ICommonSession Target, EntityUid InviterEntity, EntityUid TargetEntity, string CompanyId);
    private sealed record PendingRevealRequest(int _, ICommonSession Requester, ICommonSession Target, EntityUid RequesterEntity, EntityUid TargetEntity);
