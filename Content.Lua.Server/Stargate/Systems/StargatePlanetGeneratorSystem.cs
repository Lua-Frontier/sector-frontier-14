...
using Content.Lua.Server.Stargate.Components;
using Content.Lua.Server.Stargate.Events;
using Content.Lua.Server.Stargate.PlanetQuest;
...
public sealed class StargatePlanetGeneratorSystem : EntitySystem
{
    ...
    [Dependency] private readonly PlanetQuestSystem _planetQuest = default!;
