using System.Linq;
using Content.Lua.Server.Language.Events;
using Content.Lua.Shared.Language;
using Content.Lua.Shared.Language.Components;
using Content.Shared.Language.Systems;
using Robust.Shared.Prototypes;
using Content.Shared.Ghost;
using UniversalLanguageSpeakerComponent = Content.Lua.Shared.Language.Components.UniversalLanguageSpeakerComponent;
using Content.Shared.Language;

namespace Content.Lua.Server.Language;

public sealed partial class LanguageSystem : SharedLanguageSystem, ILanguageSystem
{
