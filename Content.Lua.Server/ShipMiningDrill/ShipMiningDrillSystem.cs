...
using Content.Lua.Shared.ShipMiningDrill;
...
namespace Content.Lua.Server.ShipMiningDrill;
...
public sealed class ShipMiningDrillSystem : EntitySystem
{
        ...
        Vector2 worldPos)
    {
        ...
        _grids.Clear();
        _map.FindGridsIntersecting(mapId, box, ref _grids, approx: true, includeMap: false);
