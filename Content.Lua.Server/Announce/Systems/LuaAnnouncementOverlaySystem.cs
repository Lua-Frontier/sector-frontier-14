...
using Content.Lua.Server.Announcements;
...
namespace Content.Lua.Server.Announce;

public sealed class LuaAnnouncementOverlaySystem : EntitySystem, ILuaAnnouncementOverlaySystem
{
