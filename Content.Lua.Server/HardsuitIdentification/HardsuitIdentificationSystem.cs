...
public sealed class HardsuitIdentificationSystem : EntitySystem
{
    ...
    private void SecurityStep(EntityUid hardsuit, EntityUid wearer, int step, HardsuitSecurityMode mode)
    {
        ...
        switch (step)
        {
            case 1:
                ...
                break;
            case 2:
                _popupSystem.PopupEntity("3", wearer, wearer, Content.Shared.Popups.PopupType.LargeCaution);
                _chat.TrySendInGameICMessage(hardsuit, "3", InGameICChatType.Speak, true);
                _audio.PlayPvs(comp.SparkSound, hardsuit);
                break;
            case 3:
                _popupSystem.PopupEntity("2", wearer, wearer, Content.Shared.Popups.PopupType.LargeCaution);
                _chat.TrySendInGameICMessage(hardsuit, "2", InGameICChatType.Speak, true);
                _audio.PlayPvs(comp.SparkSound, hardsuit);
                break;
            case 4:
                _popupSystem.PopupEntity("1", wearer, wearer, Content.Shared.Popups.PopupType.LargeCaution);
    ...
    private void StartSecuritySequence(EntityUid uid, HardsuitIdentificationComponent comp, EntityUid equipment, EntityUid equipee)
    {
        ...
        _popupSystem.PopupEntity(spikeMsg, equipee, equipee, Content.Shared.Popups.PopupType.Large);
        ...
        _popupSystem.PopupEntity(countdownStartMsg, equipee, equipee, Content.Shared.Popups.PopupType.LargeCaution);
