...
using Content.Lua.Server.StationRecords.Components;
...
namespace Content.Lua.Server.StationRecords.Systems;

public sealed class ShipCrewAssignmentSystem : EntitySystem, IShipCrewAssignmentSystem
{
