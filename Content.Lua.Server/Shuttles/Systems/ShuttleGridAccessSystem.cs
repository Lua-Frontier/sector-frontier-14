...
[UsedImplicitly]
public sealed class ShuttleGridAccessSystem : EntitySystem, IShuttleGridAccessSystem
{
    ...
    public static bool TryParseGridKind(string value, out ShuttleGridKind kind) => ShuttleGridKinds.TryParse(value, out kind);
}
