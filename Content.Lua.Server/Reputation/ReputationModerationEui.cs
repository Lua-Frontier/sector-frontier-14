...
public sealed class ReputationModerationEui : BaseEui
{
    ...
    private readonly IReputationSystem _reputation;
    ...
    public ReputationModerationEui(ReputationTargetKind targetKind, NetUserId targetUserId, string targetName)
    {
        ...
        _reputation = _entity.System<IReputationSystem>();
    ...
    private async Task ReloadStateAsync()
    {
        ...
        _reputation.SetCachedReputation(summary.Kind, summary.TargetUserId, new CachedReputation(summary.Score, summary.PositiveVotes, summary.NegativeVotes));
        StateDirty();
    }
