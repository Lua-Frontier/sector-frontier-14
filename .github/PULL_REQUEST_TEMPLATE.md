...
Запись должна содержать символ :cl: или 🆑.
Автор после символа опционален: если не указан, в журнал попадёт автор PR.
Несколько блоков :cl: / 🆑 создают несколько отдельных записей. -->
