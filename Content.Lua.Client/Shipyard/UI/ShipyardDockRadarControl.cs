...
namespace Content.Client.Lua.Shipyard.UI;

public sealed class ShipyardDockRadarControl : ShuttleNavControl, IShipyardDockRadar
{
    public Control Control => this;

    Action<EntityCoordinates>? IShipyardDockRadar.OnRadarClick
    {
        get => OnRadarClick;
        set => OnRadarClick = value;
    }
