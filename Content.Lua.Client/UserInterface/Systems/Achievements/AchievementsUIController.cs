...
using Content.Client.Lua.Achievements;
...
namespace Content.Client.Lua.UserInterface.Systems.Achievements;
...
public sealed class AchievementsUIController : UIController, IOnStateEntered<GameplayState>, IOnStateExited<GameplayState>
{
    ...
    public override void Initialize()
    {
        ...
        UIManager.GetUIController<EscapeUIController>().AchievementsRequested += OpenWindow;
    }
