...
guide-entry-lua-corp-site = Project site
guide-entry-technologies = How to unlock technologies
guide-entry-anomalous-research = Anomalies
guide-entry-scanners-and-vessels = Scanners and vessels
guide-entry-ape = A.P.E.
guide-entry-xenoarchaeology = Artifacts
