station-event-ion-storm-start-announcement = Бортовые сканеры зафиксировали ионный шторм вблизи судна. Проверьте оборудование под управлением ИИ на наличие сбоев.
