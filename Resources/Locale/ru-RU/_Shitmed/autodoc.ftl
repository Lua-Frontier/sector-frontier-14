...
autodoc-error-tend-wounds-no-damage = НЕТ ПОВРЕЖДЕНИЙ ДЛЯ ЛЕЧЕНИЯ
autodoc-title = АвтоДок MK.X
...
autodoc-verb-enter = Залезть
autodoc-verb-noun-occupant = пациента
autodoc-verb-open-ui = Открыть АвтоДок
