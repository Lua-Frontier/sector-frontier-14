...
objective-condition-abduct-description = Используйте гаджет на жертве. Затем на консоле выберите действие "притянуть". Далее замените их сердце на одну из железяк. Поместите в экспериментатор и нажмите "Завершить эксперимент".
abductor-role-greeting =
    Вы — профессиональный боевой учёный высокотехнологичной расы. Ваша задача — похищать людей, проводить над ними эксперименты, и возвращать живыми ради чистоты эксперимента. Вам невыгодно уничтожать станцию, убивать или помогать экипажу.
...
abductor-victim-role-greeting = Вы видели то, чего не должны были увидеть. Вам тяжело оправиться после такого психологического сотрясения, что отразилось на вашем поведении. Но вам запрещено причинять явный вред экипажу. Мир должен узнать правду!
...
abductor-victim-role-desc = Вы видели то, чего не должны были увидеть. Все существа, что вас окружают — абдукторы! Ну, по крайней мере, вы так подозреваете. Проводите допросы с пристрастием, устанавливайте не смертельные ловушки. Мир должен узнать правду!
