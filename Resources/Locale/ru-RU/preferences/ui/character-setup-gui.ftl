...
character-setup-gui-company-selector-subtitle = Фракцию можно поменять один раз за раунд.
...
character-setup-gui-company-selector-rejoin-locked = Этот персонаж уже покидал эту фракцию в текущем раунде и не может вступить в неё повторно.
...
humanoid-profile-editor-company-leave-info = [color=yellow]Сменить одну и ту же фракцию можно ограниченное число раз за раунд.[/color]
humanoid-profile-editor-company-neutral-info = Этот персонаж уже не состоит ни в одной фракции.
...
character-setup-gui-company-leave-window-details = Лимит применяется к текущей фракции отдельно за каждый раунд.
