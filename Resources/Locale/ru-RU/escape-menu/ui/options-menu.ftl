...
#ui-options-fancy-name-background = Добавить фон облачкам с текстом # Lua
...
#ui-options-function-hotbar1 = 1 слот хотбара # Lua
#ui-options-function-hotbar2 = 2 слот хотбара # Lua
#ui-options-function-hotbar3 = 3 слот хотбара # Lua
#ui-options-function-hotbar4 = 4 слот хотбара # Lua
#ui-options-function-hotbar5 = 5 слот хотбара # Lua
#ui-options-function-hotbar6 = 6 слот хотбара # Lua
#ui-options-function-hotbar7 = 7 слот хотбара # Lua
#ui-options-function-hotbar8 = 8 слот хотбара # Lua
#ui-options-function-hotbar9 = 9 слот хотбара # Lua
#ui-options-function-hotbar0 = 0 слот хотбара # Lua
