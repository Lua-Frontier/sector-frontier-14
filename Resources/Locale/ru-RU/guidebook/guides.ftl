...
guide-entry-wiki-luna = Wiki - Луна
guide-entry-lua-corp-site = Сайт проекта
...
guide-entry-technologies = Как открывать технологии
guide-entry-anomalous-research = Аномалии
...
guide-entry-scanners-and-vessels = Сканеры и капсулы
guide-entry-yourfirstcharacter = Ваш первый персонаж
guide-entry-ape = A.P.E.
guide-entry-xenoarchaeology = Артефакты
