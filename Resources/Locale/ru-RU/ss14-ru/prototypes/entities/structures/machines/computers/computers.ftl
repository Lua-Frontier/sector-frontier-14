...
ent-ComputerResearchAndDevelopmentSyndicate = исследовательская консоль Синдиката
    .desc = Компьютер, используемый для взаимодействия с оборудованием РнД Синдиката.
    .suffix = РНД
ent-ComputerResearchAndDevelopmentRogues = исследовательская консоль ПДВ
    .desc = Компьютер, используемый для взаимодействия с пиратским оборудованием РнД.
    .suffix = РНД
ent-ComputerResearchAndDevelopmentUssp = исследовательская консоль СССП
    .desc = Компьютер, используемый для взаимодействия с оборудованием РнД СССП.
    .suffix = РНД
ent-ComputerResearchAndDevelopmentTSFMC = Frontline Solutions
    .desc = Компьютер, используемый для взаимодействия с оборудованием РнД сил безопасности.
    .suffix = РНД
ent-ComputerResearchAndDevelopmentMerc = исследовательская консоль гражданских
    .desc = Компьютер, используемый для взаимодействия с оборудованием РнД гражданских.
    .suffix = РНД
ent-ComputerResearchAndDevelopmentLuaTech = исследовательская консоль LuaTech
    .desc = Голографическая консоль для взаимодействия с оборудованием РнД Lua Technologies.
    .suffix = РНД
