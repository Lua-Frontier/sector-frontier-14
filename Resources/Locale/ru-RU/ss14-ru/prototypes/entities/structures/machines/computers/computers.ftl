...
ent-ComputerResearchAndDevelopmentTSFMC = СРБС
    ...
    .suffix = РНД
ent-ComputerResearchAndDevelopmentMerc = исследовательская консоль наёмников
    .desc = Компьютер, используемый для взаимодействия с оборудованием РнД наёмников.
    .suffix = РНД
