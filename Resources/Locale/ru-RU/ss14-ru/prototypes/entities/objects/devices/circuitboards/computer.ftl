...
ent-ResearchComputerTSFMCCircuitboard = СРБС (консольная плата)
    ...
    .suffix = РНД
ent-ResearchComputerMercCircuitboard = исследовательская консоль наёмников (консольная плата)
    .desc = Консольная плата для исследовательской консоли наёмников.
    .suffix = РНД
