...
ent-EnergySwordCivil = гражданский энергетический меч
    .desc = Гражданская версия энергетического меча, которую можно использовать, чтобы порезать себе колбаску или вырезать все население астероида.
