...
namespace Content.Client.Administration.UI.Tabs.AdminTab
{
    ...
    public sealed partial class PlayerActionsWindow : DefaultWindow
    {
        ...
        public PlayerActionsWindow()
        {
            ...
            SubmitReputationButton.OnPressed += SubmitReputationButtonOnPressed;
        ...
        private void OnListOnOnSelectionChanged(PlayerInfo? obj)
        {
            ...
            SubmitReputationButton.Disabled = disableButtons;
        ...
        private void SubmitReputationButtonOnPressed(BaseButton.ButtonEventArgs obj)
        {
            if (_selectedPlayer == null) return;
            IoCManager.Resolve<IClientConsoleHost>().ExecuteCommand($"reputationpanel player \"{_selectedPlayer.SessionId}\"");
        }
    }
}
