...
using Content.Client._Lua.UserInterface.Systems.LunaPlan;
...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class LobbyGui : UIScreen
    {
        ...
        public LobbyGui()
        {
            ...
            RoadmapButton.OnPressed += _ => UserInterfaceManager.GetUIController<LunaPlanUIController>().ToggleBoard();
        }
