...
namespace Content.Client.Options.UI
{
    ...
    public sealed partial class OptionsMenu : DefaultWindow
    {
        ...
        public OptionsMenu()
        {
            ...
            if (IoCManager.Instance!.TryResolveType<INetworkOptionsTabFactory>(out var networkTabFactory))
            {
                var networkTab = networkTabFactory.Create();
                networkTab.Name = "NetworkTab";
                Tabs.AddChild(networkTab);
            }
