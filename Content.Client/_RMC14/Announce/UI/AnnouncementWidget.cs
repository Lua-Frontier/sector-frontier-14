...
public sealed partial class AnnouncementWidget : UIWidget
{
    ...
    private EntityUid? _ownedPortraitHologram;
    ...
    public void ShowAnnouncement(AnnouncementDisplayData announcement)
    {
        ...
        ResetLayoutState();
        var resolvedStyle = AnnouncementStyling.CreateDisplayStyle(announcement.Style, announcement.LayoutScale);
    ...
    internal void OwnPortraitHologram(EntityUid hologram)
    {
        _ownedPortraitHologram = hologram;
    }
