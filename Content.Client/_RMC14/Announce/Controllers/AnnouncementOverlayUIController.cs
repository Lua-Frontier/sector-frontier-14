...
public sealed class AnnouncementOverlayUIController : UIController, IOnStateEntered<GameplayState>, IOnStateExited<GameplayState>
{
    ...
    {
        base.Initialize();
        _cfg.OnValueChanged(LuaCCVars.AnnouncementMaxVisible, OnMaxVisibleAnnouncementsChanged, true);
    }
    ...
    private void OnMaxVisibleAnnouncementsChanged(int value)
    {
        ...
        if (value != clamped)
        {
            _cfg.SetCVar(LuaCCVars.AnnouncementMaxVisible, clamped);
            return;
        }
    ...
    private bool EnqueueAnnouncement(QueuedAnnouncement announcement)
    {
