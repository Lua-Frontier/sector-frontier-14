...
public static class AnnouncementLayoutOverrides
{
    ...
    private static string SerializeLayout(AnnouncementLayoutOverride layout)
    {
        ...
        serialized.Append(',');
        serialized.Append(clamped.TextColor ?? string.Empty);
        serialized.Append(',');
        serialized.Append(clamped.TitleColor ?? string.Empty);
        serialized.Append(',');
        ...
        serialized.Append(',');
        serialized.Append(clamped.SpriteBoxColor ?? string.Empty);
        serialized.Append(',');
        serialized.Append(clamped.SpriteBoxBorderColor ?? string.Empty);
        serialized.Append(',');
        serialized.Append(clamped.CRTGlowColor ?? string.Empty);
        serialized.Append(',');
        serialized.Append(clamped.BackgroundColor ?? string.Empty);
        return serialized.ToString();
    }
