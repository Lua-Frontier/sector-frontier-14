...
public sealed partial class LatheMenu : DefaultWindow
{
    ...
    private string GenerateTooltipText(LatheRecipePrototype prototype)
    {
        ...
        foreach (var (id, amount) in prototype.Materials)
        {
            ...
            var adjustedAmount = SharedLatheSystem.AdjustMaterial(amount, prototype.MaterialDiscountScale, multiplier) * quantity; //Lua
        ...
        foreach (var (id, amount) in prototype.Entities)
        {
            ...
            if (missingAmount > 0)
                tooltipText = Loc.GetString("lathe-menu-entity-amount-missing", ("amount", needed), ("missingAmount", missingAmount), ("unit", ""), ("material", name));
            else
                tooltipText = Loc.GetString("lathe-menu-tooltip-display", ("material", name), ("amount", needed));
        ...
        foreach (var (id, amount) in prototype.Reagents)
        {
            ...
            if (missingAmount > 0)
                tooltipText = Loc.GetString("lathe-menu-reagent-amount-missing", ("amount", needed), ("missingAmount", missingAmount), ("unit", "u"), ("material", name));
            else
                tooltipText = Loc.GetString("lathe-menu-tooltip-display", ("material", name), ("amount", needed));
